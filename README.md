...
At the end of the day, the technologies implemented in this project are React, Styled Components, Enzyme, and Gh Pages to deploy it. I choose to use as fewer frameworks as possible to minimize initial setup and invest more time in diving into weird technological rabbit holes. In the next iteration with more time, I would like to implement a city search field input for the forecast searching of other cities and possibly testing more depth the application.
